...
function for the true properties $\set{z_m}$ of all of the stars $m$
...
observing observed properties $y_m$ for star $m$ under the assumption
...
These three factors combine into a likelihood function as follows:
